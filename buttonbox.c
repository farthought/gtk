...
int main(int argc, char **argv)
{
    ...
    gtk_box_pack_start(GTK_BOX(vbox), create_bbox(TRUE, "Sparead (spacing 40)", 40, 85, 20, GTK_BUTTONBOX_SPREAD), TRUE, TRUE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(hbox), create_bbox(FALSE, "Sparead (spacing 40)", 40, 85, 20, GTK_BUTTONBOX_SPREAD), TRUE, TRUE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(hbox), create_bbox(FALSE, "End (spacing 10)", 10, 85, 20, GTK_BUTTONBOX_END), TRUE, TRUE, 5);
