...
/* 工具栏上第一项是<close>按钮 */
  iconw = gtk_image_new_from_file ("/home/sg-os/桌面/png/system-shutdown.png"); /* 图标构件 */
  close_button = 
...
/* 现在，我们创建单选按钮组... */
  iconw = gtk_image_new_from_file ("/home/sg-os/桌面/png/gtk-ok.png");
...
/* 后面的单选按钮引用前面创建的 */
  iconw = gtk_image_new_from_file ("/home/sg-os/桌面/png/gtk-no.png");
  text_button = 
  ...
  iconw = gtk_image_new_from_file ("/home/sg-os/桌面/png/gtk-media-stop.png");
  both_button = 
    gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                GTK_TOOLBAR_CHILD_RADIOBUTTON,
                                text_button,
